...
/**
 * initialise the variable `rabbit` to the value of 5
 * increment rabbit by 10
 * console log the rabbit. Write a single line comment as to what will be displayed
 */
var rabbit = 5;
rabbit += 10;
console.log(rabbit);  // 15
...
/**
 * initialise the variable `dog legs` to the value of 4
 * initialise the variable `spider legs` to the value of 8
 * initialise total to the average of dog legs and spider legs
 * console log the total. Write a single line comment as to what will be displayed
 */
 var dogLegs = 4;
 var spiderLegs = 8;
 var total = (dogLegs + spiderLegs) / 2;
 console.log(total);  // 6
...
/**
 * initialise the variable `my cat` to the value of 2
 * initialise the variable `my bag` to the value of 1
 * initialise the variable `my chocolate` to the value of 20
 * initialise total to the average of my cat, my bag, my chocolate
 * console log the total and only show 2 decimal places using the .toFixed method. Write a single line comment as to what will be displayed
 */
var myCat = 2;
var myBag = 1;
var myChocolate = 20;
var total = (myCat + myBag + myChocolate) / 3;
console.log(total.toFixed(2));    // 7.67